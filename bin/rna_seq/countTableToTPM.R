...
" Read in GTF file "
info("Get gene lengths for normalisation .... This takes time")
...
write.csv(tpm_annot, file=paste(title,"annot.tpm.csv",sep=""), row.names=F)
...
write.csv(rpkm_annot, file=paste(title,"annot.rpkm.csv",sep=""), row.names=F)
